...
public:
    ...
    UDPPacketsHandler(const char *filename,UPD_ENUM_COMMANDS command);
    ...
    unsigned int get_total_message_size() { return total_msg_size; }
    ...
    void reset_Handler(std::string filepath);
